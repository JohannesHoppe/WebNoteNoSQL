<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<WebNoteNoSQL.Models.NoteWithCategories>>" %>
<%@ Import Namespace="WebNoteNoSQL.Code.HtmlHelperExtensions" %>
<%@ Import Namespace="WebNoteNoSQL.Models" %>

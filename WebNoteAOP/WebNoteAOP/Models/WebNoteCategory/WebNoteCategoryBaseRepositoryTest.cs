...
namespace WebNoteAOP.Models.WebNoteCategory.WebNoteCategoryUnitTest
{
    ...
    [TestClass]
    public abstract class WebNoteCategoryBaseRepositoryTest
    {
        /// <summary>
        /// Gets the mocked context
        /// </summary>
        /// <value>mocked context</value>	
        public WebNoteCategoryMock Context { get; set; }
        
        /// <summary>
        /// Gets the repository to test
        /// </summary>
        /// <value>initialized repository.</value>
        public WebNoteCategoryRepository Repository  { get; set; }
        ...
        public void InitializeRepository()
        {
            ...
            Repository = new WebNoteCategoryRepository { Context = Context };
        ...
        /// </summary>
        public abstract List<Category> CreateCategoriesList();		
    
        /// <summary>
        /// Method should return a collection for the MockObjectSet - to be implemented!
        /// </summary>
        public abstract List<CategoryToNode> CreateCategoryToNodesList();		
